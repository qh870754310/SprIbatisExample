...
public class HomeController {
	...
	//系统管理模块
	@RequestMapping(value = "/sysadminMain.action")
	public String sysadminMain() {
		return "/sysadmin/main.jsp";
	}
	
	@RequestMapping(value = "/sysadminLeft.action")
	public String sysadminLeft() {
		return "/sysadmin/left.jsp";
	}
	
	//基础信息模块
	@RequestMapping(value = "/baseinfoMain.action")
	public String baseinfoMain() {
		return "/baseinfo/main.jsp";
	}
	
	@RequestMapping(value = "/baseinfoLeft.action")
